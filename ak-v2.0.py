...
\x1b[38;5;46m
    ...
    ╚═╝  ╚═╝╚═╝     ╚═╝╚═╝  ╚═╝╚═╝  ╚═══╝
\x1b[38;5;46m===============================================   
           CREATED BY   :  AMAN KHAN            
           ON GITHUB    :  5UP3R1              
           TOOL VERSION :  2.0                    
           TOOL STATUS  :  RANDOM CLONING       
           COUNTRY      :  BANGLADESH             \033
\x1b[38;5;46m===============================================
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93m[AmaN]\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/5UP3R1/crack-v2/blob/main/Aproval.ax").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am Aman's ROBOT. Sir this tool is paid because 100% ok id just now login\"")
